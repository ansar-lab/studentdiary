...
import { GraduationCap, LogOut, User, Mail, Hash, BookOpen, Building, Edit, Save, X, Camera } from "lucide-react";
            ...
            <div className="flex flex-col items-center -mt-16 mb-4">
              <div className="relative group">
                <Avatar className="w-32 h-32 border-4 border-card shadow-xl">
                  ...
                  <AvatarFallback className="bg-gradient-to-br from-primary to-accent text-5xl text-primary-foreground font-bold">
